...
Embox предоставляет слой POSIX-совместимости, который позволяет использовать большое количество готового ПО разработанного под Linux. Примерами являются библиотека Qt, клиент и сервер SSH — Dropbear, проект по созданию sip-телефонов PJSIP.
 ...
 * Для упрощения работы проинтерпретируйте скрипт командой 
```
